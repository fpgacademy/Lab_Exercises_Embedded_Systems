...
is played on the audio device of the DE10-Nano board, and (if the optional -w argument is given)
is also written to the file piano.wav. This is an MS Windows audio file.
