...
scale is played on the audio device of the DE10-Nano board, and is also written (if the 
optional -w argument is given) to the file .wav. This is an MS Windows audio file.
